...
function TimeSeriesChart() {
  ...
  return (
    <div className="bg-white rounded-3xl shadow-2xl overflow-hidden p-12">
      {/* Header */}
      <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white py-6 px-8 rounded-xl mb-8 -mt-12 -mx-12">
        <h2 className="text-6xl font-extrabold text-center">2025 Facebook Ads Trends</h2>
        ...
        <ResponsiveContainer width="100%" height={500}>
          ...
          >
            ...
            <YAxis
              ...
              tick={{ fontSize: 16, fontWeight: 'bold' }}
              stroke="#6b7280"
              label={{ value: 'CTR (%) & Reactions (Log Scale)', angle: 90, position: 'insideRight', style: { fontSize: 18, fontWeight: 'bold' } }}
            />
            ...
            {visibleLines >= 4 && (
              <Line
                ...
                dataKey={lines[3].key}
                name={lines[3].name}
                stroke={lines[3].color}
                strokeWidth={lines[3].strokeWidth}
                yAxisId={lines[3].yAxisId}
                dot={{ fill: lines[3].color, r: 6 }}
                activeDot={{ r: 8 }}
                animationDuration={1500}
                animationEasing="ease-in-out"
              />
      ...
      <div className="flex justify-center items-center gap-6">
        <button
          ...
          className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold py-4 px-12 rounded-full text-3xl shadow-xl transition-all hover:scale-105 active:scale-95"
        >
          {visibleLines === 0 ? 'Start Animation' : visibleLines === 4 ? 'Restart' : 'Next Metric'}
        </button>
